package com.example.parking.modeloweb;
...
public class FormDatesWeb extends JFrame{
    ...
    public FormDatesWeb() {
        ...
        rdbBuscarRango = new JRadioButton("Opción por rango");
        rdbBuscarTodo = new JRadioButton("Opción todo");    
        
        butGroGrupo = new ButtonGroup();
        butGroGrupo.add(rdbBuscarId);
        butGroGrupo.add(rdbBuscarRango);
        butGroGrupo.add(rdbBuscarTodo);
        
        textSelecId = new JTextField(4);
        textSelecRangoMin = new JTextField(4);
        textSelecRangoMax = new JTextField(4);
       
        panelHead.add(labelFiltrar);
        panelHead.add(textFiltrar);
        panelHead.add(cmbTipo);
        panelHead.add(cmbTabla);
        panelHead.add(botonListar);
        panelHead.add(rdbBuscarId);
        panelHead.add(textSelecId);
        panelHead.add(rdbBuscarRango);
        panelHead.add(textSelecRangoMin);
        panelHead.add(textSelecRangoMax);
